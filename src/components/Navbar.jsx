    ...
    <header className="w-full border-b border-gray-200">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-8 md:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4 md:gap-10">
          ...
          <div className="hidden md:flex">
            <div className="flex h-14 w-105 items-center rounded-full border border-gray-200 px-5">
      ...
      <div className="px-4 pb-5 md:hidden">
        <div className="mb-6 flex items-start justify-between">
          <Link to='/'>
            <h1 className="text-4xl font-bold tracking-tight text-blue-600">MORENT</h1>
          </Link>
        ...
        <div className="flex items-center gap-4">
          <div className="flex h-16 flex-1 items-center gap-3 rounded-3xl border border-gray-200 px-5">
            <Search size={28} className="text-gray-500 shrink-0" />
            <input
              type="text"
              placeholder="Search something here"
